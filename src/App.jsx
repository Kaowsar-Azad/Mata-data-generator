...
import { BackgroundRemover } from './components/BackgroundRemover/index.jsx'
...
import { EpsPreviewGenerator } from './components/EpsPreviewGenerator.tsx'
...
function App() {
  ...
  return (
    <div className="dashboard-layout">
      {/* ─── LEFT SIDEBAR ─── */}
      <aside className={`dashboard-sidebar ${activeTab === 'ftp' || activeTab === 'topsellers' || activeTab === 'upscale' ? 'sidebar-compact' : ''}`} style={{
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    fontWeight: 700,
                    fontSize: activeTab === 'ftp' || activeTab === 'topsellers' || activeTab === 'upscale' ? '0.8rem' : '0.73rem',
                    display: 'flex',
                    alignItems: 'center',
