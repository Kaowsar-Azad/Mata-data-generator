...
export const AdobeSearchOption: React.FC<AdobeSearchOptionProps> = ({
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.75rem', maxWidth: '850px', margin: '0 auto 2rem auto', width: '100%' }}>
      {/* Search Bar */}
      <form onSubmit={handleSearch} style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', paddingLeft: '1rem' }}>
          <Search style={{ width: '1.25rem', height: '1.25rem', color: 'var(--text-3)' }} />
        </div>
        <input
          type="text"
