...
function safeGetItem(key) {
  try {
    ...
    console.warn('localStorage access failed (getItem):', e.message);
  }
...
function safeSetItem(key, value) {
  try {
    ...
    console.warn('localStorage access failed (setItem):', e.message);
  }
...
function safeRemoveItem(key) {
  try {
    ...
    console.warn('localStorage access failed (removeItem):', e.message);
  }
