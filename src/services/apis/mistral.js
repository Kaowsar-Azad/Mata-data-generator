...
/**
 * Build the metadata prompt depending on file context for Mistral.
 */
export function buildMistralPrompt({ isEps, isPlaceholder, isVideo, fileName, extractedTextContext, promptSettings, skipPolicyScan }) {
...
` : "";
  ...
  const jsonSample = enableRanking
    ? `{"title":"...","description":"...","keywords":"apple, technology, screen, ... (${promptKeywordsCount} total)","keywordScores":{"apple":95,"technology":80,"screen":65},"categories":${sampleCat}${policyWarningField}}`
    : `{"title":"...","description":"...","keywords":"apple, technology, screen, ... (${promptKeywordsCount} total)","categories":${sampleCat}${policyWarningField}}`;
