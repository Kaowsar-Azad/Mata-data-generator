...
/**
 * Build the metadata prompt depending on file context for OpenRouter.
 */
export function buildOpenRouterPrompt({ isEps, isPlaceholder, isVideo, fileName, extractedTextContext, promptSettings }) {
...
Return only the prompt text and nothing else.`;
  ...
  return fetchOpenAICompatible("openrouter", endpoint, models, apiKey, processedPrompt, base64Data, mimeType, forceJson, promptSettings);
}
